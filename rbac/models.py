...
from .manager.user import MyUserManager
...
class UserProfile(AbstractUser):
    ...
    用户
    """
    username = models.CharField(max_length=20, default="", verbose_name="姓名")
    ...
    department = models.ForeignKey("Organization", null=True, blank=True, on_delete=models.SET_NULL,
                                   verbose_name="部门")
    position = models.CharField(max_length=50, null=True, blank=True, verbose_name="职位")
    superior = models.ForeignKey("self", null=True, blank=True, on_delete=models.SET_NULL, verbose_name="上级主管")
    roles = models.ManyToManyField("Role", verbose_name="角色", blank=True)
    is_admin = models.BooleanField('是否可以登录后台', default=False)
